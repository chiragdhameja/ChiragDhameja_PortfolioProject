...
export default function About({ pageInfo }: Props) {
  return (
    <motion.div
      ...
      <div className='space-y-1 mob:space-y-5 -mt-10 mob:-mt-32 px-0 md:px-10 z-20'>
        <h4 className='text-2xl sm:text-4xl font-semibold text-purple-9'>Here is a <span className='underline decoration-purple-8'>
            little</span> background
        </h4>
        <p className='text-sm text-purple-9'>
