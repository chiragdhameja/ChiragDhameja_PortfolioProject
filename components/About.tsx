...
export default function About({ pageInfo }: Props) {
  return (
    <motion.div
      ...
      md:text-left md:flex-row max-w-7xl px-10 justify-evenly -space-y-17- mx-auto items-center'>

      <h3 className='absolute top-20 sm:top-24 uppercase tracking-[20px] text-purple-9 text-2xl'>About</h3>
      ...
      <div className='space-y-5 px-0 md:px-10 z-10'>
